...
public static class UiLocale
{
    ...
    static readonly Dictionary<string, (string ru, string en)> Table =
        new Dictionary<string, (string, string)>(StringComparer.Ordinal)
        {
            ...
            { "menu.test_yard", ("ТЕСТ-двор", "TEST yard") },
            ...
            { "menu.seed_field", ("Сид (пусто — случайный)", "Seed (empty = random)") },
            { "menu.seed_random", ("Случайный", "Random") },
            { "menu.seed_copy", ("Как в последнем мире", "From last world") },
            { "menu.world_coins", ("Монеты: {0}", "Coins: {0}") },
            ...
            { "pause.session", ("Сессия {0}  ·  зданий {1}  ·  лент {2}  ·  предметов {3}  ·  монет +{4}", "Session {0}  ·  buildings {1}  ·  belts {2}  ·  items {3}  ·  coins +{4}") },
            { "pause.achievements", ("Достижения", "Achievements") },
            { "ach.toast", ("Достижение", "Achievement") },
            { "ach.first_belt", ("Первая лента", "First belt") },
            { "ach.first_belt_body", ("Поставь конвейер.", "Place a conveyor.") },
            { "ach.first_extractor", ("Первый экстрактор", "First extractor") },
            { "ach.first_extractor_body", ("Поставь экстрактор на жилу.", "Place an extractor on a vein.") },
            { "ach.first_smelt", ("Первая плавка", "First smelt") },
            { "ach.first_smelt_body", ("Выплавь слиток.", "Smelt an ingot.") },
            { "ach.first_research", ("Первое исследование", "First research") },
            { "ach.first_research_body", ("Закрой узел в лаборатории.", "Complete a lab research node.") },
            { "ach.first_underground", ("Под землёй", "Underground") },
            { "ach.first_underground_body", ("Поставь подземный конвейер.", "Place an underground conveyor.") },
            { "ach.first_splitter", ("Развилка", "Splitter") },
            { "ach.first_splitter_body", ("Поставь разделитель.", "Place a splitter.") },
            { "ach.first_pipe", ("Труба", "Pipe") },
            { "ach.first_pipe_body", ("Поставь трубу.", "Place a pipe.") },
            { "ach.gears_1000", ("Тысяча шестерён", "A thousand gears") },
            { "ach.gears_1000_body", ("Произведи 1000 шестерёнок.", "Produce 1000 gears.") },
            { "ach.coins_5000", ("Казна", "Treasury") },
            { "ach.coins_5000_body", ("Накопи 5000 монет.", "Hold 5000 coins.") },
            { "ach.night_watch", ("Ночь без читов", "Night without cheats") },
            { "ach.night_watch_body", ("Дождись ночи, не крутя время в настройках и консоли.", "Reach night without changing time in settings or console.") },
            { "ach.first_generator", ("Свет в цеху", "Factory light") },
            { "ach.first_generator_body", ("Поставь генератор.", "Place a generator.") },
            { "ach.factory_25", ("Цех", "Shop floor") },
            { "ach.factory_25_body", ("Поставь 25 зданий за заход.", "Place 25 buildings this session.") },
            { "idle.title", ("Простой: {0}", "Idle: {0}") },
            { "idle.no_input", ("нет входа", "no input") },
            { "idle.output_full", ("выход забит", "output full") },
            ...
            { "machine.tab_idle", ("Простой", "Idle") },
            { "idle.empty", ("Проблем нет", "No issues") },
            ...
            { "machine.belt_filter", ("Фильтр ленты: {0}", "Belt filter: {0}") },
            { "machine.extractor_front", ("Только передний выход", "Front output only") },
            { "machine.extractor_front_on", ("Выдаёт только в клетку перед сокетом (лента / печь)", "Outputs only to the cell in front (belt / furnace)") },
            { "machine.extractor_front_off", ("Выдаёт во все соседние приёмники", "Outputs to any neighbouring acceptor") },
            { "machine.powered", ("Питание", "Powered") },
            { "machine.power_on", ("Горит {0} с", "Burning {0}s") },
            { "machine.power_off", ("Нет топлива", "No fuel") },
            ...
            { "modal.ok", ("ОК", "OK") },
            { "select.extractors_title", ("Экстракторы на жилы", "Extractors on veins") },
            { "select.extractors_body", ("Поставить экстракторы на {0} жил за {1} монет?", "Place extractors on {0} veins for {1} coins?") },
            { "select.extractors_ok", ("Поставить", "Place") },
            ...
            { "hint.ride_belt", ("сесть на ленту", "ride belt") },
            { "hint.belt_menu", ("настроить ленту", "configure belt") },
            ...
            { "tut.skip_key", ("{0} — всё   ·   {1} — шаг   ·   {2} — повтор", "{0} — skip all   ·   {1} — skip step   ·   {2} — repeat") },
            { "tut.repeat", ("Повторить шаг", "Repeat step") },
            { "tut.skip_lab", ("До лаборатории", "Skip to lab") },
            { "tut.skip_belts", ("До лент", "Skip to belts") },
